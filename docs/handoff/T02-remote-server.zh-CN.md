...
这是一份操作说明，审计者尚未连接或配置用户服务器。截至 2026-09-20，用户已验证远端 Docker/Compose 和四个基础镜像拉取（准备阶段 1–4）；T02 第二轮审计仍有两项修复，见 [审计报告](reports/T02-review-round2.md)。修复提交完成且隔离代码复核后再做 5–8。不要上传半成品、根 .env、开发数据库、.venv 或 node_modules。
